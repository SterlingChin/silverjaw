...
export const Resume = () => {
    return (
        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="file-user" class="svg-inline--fa fa-file-user fa-w-12" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
